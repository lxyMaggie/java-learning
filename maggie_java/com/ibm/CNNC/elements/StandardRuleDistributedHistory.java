...
/*catalog\widget\dm\docmanage\standardruledistributedhistory\templates\StandardRuleDistributedHistory.html*/
public class StandardRuleDistributedHistory {
	protected WebDriver driver;
	private static final String dDefaultGrid_XPath="//descendant::div[contains(@id,'StandardRuleDistributedHistory')]/descendant::div[contains(@id,'DataGrid')]";

	//----Constructor Methods Begin----
	public StandardRuleDistributedHistory(WebDriver driver){
		this.driver=driver;
	}

	/*StandardRuleDistributedHistory->defaultGrid*/
