...
/*catalog\widget\layout\templates\ServiceView.html*/
public class ServiceView {
	protected WebDriver driver;
	private static final String Tabs_XPath="//descendant::div[contains(@id,'ServiceView')]/descendant::div[contains(@id,'dijit_layout_TabContainer')]";

	//----Constructor Methods Begin----
	public ServiceView(WebDriver driver){
		this.driver=driver;
	}

	/*ServiceView->stackContainer*/
