...
/*catalog\widget\dm\sysmanage\dynamicformconfig\templates\DynamicFormConfig.html*/
public class DynamicFormConfig {
	protected WebDriver driver;
	private static final String saveViewBtn_XPath="//descendant::div[contains(@id,'DynamicFormConfig')]/descendant::*[contains(@id,'ViewMetaDataConfig')]/descendant::span[contains(@id, 'Button')][normalize-space(text())='"+"保存"+"']";
	private static final String upArrow_XPath="//descendant::div[contains(@id,'DynamicFormConfig')]/descendant::*[contains(@id,'ViewMetaDataConfig')]/descendant::span[contains(@id, 'Button')][normalize-space(text())='"+""+"']";
	private static final String downArrow_XPath="//descendant::div[contains(@id,'DynamicFormConfig')]/descendant::*[contains(@id,'ViewMetaDataConfig')]/descendant::span[contains(@id, 'Button')][normalize-space(text())='"+""+"']";
	private static final String moveToBtn_XPath="//descendant::div[contains(@id,'DynamicFormConfig')]/descendant::*[contains(@id,'ViewMetaDataConfig')]/descendant::span[normalize-space(text())='"+CommonClass.getMessageValue(CommonClass.local,"${resourceBundle.moveTo}")+"']";
	private static final String updateTemplate_XPath="//descendant::div[contains(@id,'DynamicFormConfig')]/descendant::*[contains(@id,'ViewMetaDataConfig')]/descendant::span[contains(@id, 'Button')][normalize-space(text())='"+"${resourceBundle.updateTemplate}"+"']";
	private static final String moveBtn_XPath="//descendant::div[contains(@id,'DynamicFormConfig')]/descendant::*[contains(@id,'ViewMetaDataConfig')]/descendant::span[contains(@id, 'Button')][normalize-space(text())='"+"${resourceBundle.ok}"+"']";
	private static final String metaDataGrid_XPath="//descendant::div[contains(@id,'DynamicFormConfig')]/descendant::*[contains(@id,'ViewMetaDataConfig')]/descendant::div[contains(@id,'EnhancedGrid')]";
	private static final String addGroupBtn_XPath="//descendant::div[contains(@id,'DynamicFormConfig')]/descendant::*[contains(@id,'GroupConfig')]/descendant::span[contains(@id, 'Button')][normalize-space(text())='"+"创建分组"+"']";
	private static final String saveBtn_XPath="//descendant::div[contains(@id,'DynamicFormConfig')]/descendant::*[contains(@id,'GroupConfig')]/descendant::span[contains(@id, 'Button')][normalize-space(text())='"+"保存"+"']";

	//----Constructor Methods Begin----
	public DynamicFormConfig(WebDriver driver){
		this.driver=driver;
	}

	/*DynamicFormConfig->ViewMetaDataConfig->saveViewBtn*/
	...
	/*DynamicFormConfig->ViewMetaDataConfig->upArrow*/
	...
	/*DynamicFormConfig->ViewMetaDataConfig->downArrow*/
	...
	/*DynamicFormConfig->ViewMetaDataConfig->moveToBtn*/
	...
	/*DynamicFormConfig->ViewMetaDataConfig->updateTemplate*/
	...
	/*DynamicFormConfig->ViewMetaDataConfig->moveBtn*/
	...
	/*DynamicFormConfig->ViewMetaDataConfig->metaDataGrid*/
	...
	/*DynamicFormConfig->GroupConfig->addGroupBtn*/
	...
	/*DynamicFormConfig->GroupConfig->saveBtn*/
